    ...
    return(
        <>
            ...
            <div className="flex flex-col bg-slate-100 dark:bg-slate-700 rounded-md w-full sm:w-[70%] p-5 shadow-md">
                ...
                <p className='text-stone-600 dark:text-slate-200'>{bio}</p>
                <p><strong>Company: </strong><span className='text-stone-600 dark:text-slate-400'>{company}</span></p>
                <p><strong>Location: </strong><span className='text-stone-600 dark:text-slate-400'>{location}</span></p>
                <p><strong>Email: </strong><span className='text-stone-600 dark:text-slate-400'>{email}</span></p>
                <p><strong>Public repos: </strong><span className='text-stone-600 dark:text-slate-400'>{public_repos}</span></p>
